...
const teamData = [
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_1.png`,
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_2.png`,
    department: "Emergency Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_3.png`,
    department: "Emergency Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_4.png`,
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_5.png`,
    department: "Pediatric Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_6.png`,
    department: "Pediatric Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_7.png`,
    department: "Emergency Department",
    name: "Dr. Lisa Chen, MD",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_8.png`,
    department: "Emergency Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_9.png`,
    department: "Emergency Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_10.png`,
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_11.png`,
    department: "Psychiatry Department",
  ...
  {
    imgUrl: `${process.env.PUBLIC_URL}/images/doctors/doctor_12.png`,
    department: "Psychiatry Department",
...
export default function Doctors() {
  ...
  return (
    <>
      <BannerSectionStyle5
        bgUrl={`${process.env.PUBLIC_URL}/images/doctors/banner_bg.svg`}
        imgUrl={`${process.env.PUBLIC_URL}/images/doctors/banner_img.png`}
      ...
      <Section className="cs_footer_margin_0">
        <BannerSectionStyle4
          bgUrl={`${process.env.PUBLIC_URL}/images/doctors/banner_bg_2.jpeg`}
