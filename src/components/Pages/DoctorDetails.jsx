    ...
    <>
      ...
      <Section bottomMd={190} bottomLg={150} bottomXl={110}>
        <DoctorDetailsSection
          bgUrl={`${process.env.PUBLIC_URL}/images/doctors/doctor_details_bg.svg`}
          imgUrl={`${process.env.PUBLIC_URL}/images/doctors/doctor_details.jpeg`}
          ...
          contactInfo={[
            {
              iconUrl: `${process.env.PUBLIC_URL}/images/icons/call.svg`,
              title: "+123+456-7890",
            },
            {
              iconUrl: `${process.env.PUBLIC_URL}/images/icons/envlope.svg`,
      ...
      <Section bottomMd={200} bottomLg={150} bottomXl={110}>
        <AppointmentSectionStyle2
          bgUrl={`${process.env.PUBLIC_URL}/images/home_2/appointment_bg.svg`}
          imgUrl={`${process.env.PUBLIC_URL}/images/home_2/appointment_img.png`}
