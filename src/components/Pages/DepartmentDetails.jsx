    ...
    <>
      <Section topMd={135} topLg={100} topXl={100}>
        <AboutSectionStyle2
          ...
          imgUrl={`${process.env.PUBLIC_URL}/images/departments/department_img_1.png`}
        />
      </Section>
      ...
      >
        <AppointmentSection
          ...
          imgUrl={`${process.env.PUBLIC_URL}/images/home_1/appointment.jpeg`}
        />
      </Section>
      {/* End Appointment Section */}
      <Section className="cs_footer_margin_0">
        <BannerSectionStyle7
          imgUrl={`${process.env.PUBLIC_URL}/images/departments/banner_img_3.png`}
          bgUrl={`${process.env.PUBLIC_URL}/images/departments/banner_bg_3.svg`}
